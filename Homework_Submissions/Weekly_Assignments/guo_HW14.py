...
# TODO: Your code here
test = xr.open_mfdataset(downloaded_files)
...
test.attrs
test.attrs['author']
print('The author is', test.attrs['author'])
#%%
# Step 4:
...
#TODO: Your code here
for var in test:
    print(test[var].attrs['description'],
...
# 
# TODO: Your code here
np.corrcoef(spatial_mean_ds['mean_vapor_pressure_deficit'],
...
coarse_amount = dict(lon=4,lat=4)

coarse_ds = test.coarsen(
    coarse_amount, 
    boundary='trim'
).mean()
coarse_ds
